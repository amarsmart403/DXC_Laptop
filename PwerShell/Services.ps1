...
foreach ($ser in $service){
    $Dir = "C:\Users\amodepalli\Desktop\PwerShell\task2" + "\" + $ser.Status
    ...
    if ($RunSer -eq $true){
        $RSerName = $ser.Name     
        $FilePathR = "C:\Users\amodepalli\Desktop\PwerShell\task2\Running" + "\" + $RSerName + ".txt"
    ...
    if ($StopSer -eq $true){
        $SSerName = $ser.Name
        $FilePathS = "C:\Users\amodepalli\Desktop\PwerShell\task2\Stopped" + "\" + $SSerName + ".txt"
